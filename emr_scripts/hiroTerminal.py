...
import hiroStatAndMatchDefault.py as hiro
...
parser.add_argument("--type", default='all', choices=['stat','match','all'], help="Type of test desired. Choices: [stat,match,all]. Default is all")
...
clientTest = hiro(clientFile=args.s3loc, ticket=ticket)
